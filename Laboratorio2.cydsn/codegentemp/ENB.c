...
{
    uint8 staticBits = (ENB_DR & (uint8)(~ENB_MASK));
    ENB_DR = staticBits | ((uint8)(value << ENB_SHIFT) & ENB_MASK);
}
...
{
	CyPins_SetPinDriveMode(ENB_0, mode);
}
...
uint8 ENB_Read(void)
{
    return (ENB_PS & ENB_MASK) >> ENB_SHIFT;
}
...
{
    return (ENB_DR & ENB_MASK) >> ENB_SHIFT;
}


/* If interrupt is connected for this Pins component */ 
#if defined(ENB_INTSTAT) 
    ...
    *******************************************************************************/
    ...
    {
		if((position & ENB_0_INTR) != 0u) 
		{ 
			 ENB_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *******************************************************************************/
    ...
    {
        return (ENB_INTSTAT & ENB_MASK) >> ENB_SHIFT;
    }
